...
def run(train_dir, val_dir, test_dir,
        ...
        image_normalize=False, imageset_normalize=True,
        imageset_mean=116.77, imageset_std=19.23,
    ...
    if load_train_ram:
        ...
        raw_generator = raw_imgen.flow_from_directory(
            ...
            batch_size=train_bs, shuffle=False, image_normalize=image_normalize, 
        ...
        train_generator = train_imgen.flow(
            ...
            shuffle=True, seed=random_seed, image_normalize=image_normalize, 
            imageset_normalize=imageset_normalize, imageset_mean=imageset_mean, imageset_std=imageset_std)
    else:
        print "Create generator for train set"
        train_generator = train_imgen.flow_from_directory(
            ...
            preprocess=preprocess_input, shuffle=True, seed=random_seed, image_normalize=image_normalize, 
            imageset_normalize=imageset_normalize, imageset_mean=imageset_mean, imageset_std=imageset_std)
    ...
    validation_set = val_imgen.flow_from_directory(
        ...
        equalize_hist=equalize_hist, dup_3_channels=dup_3_channels,
        classes=class_list, class_mode='categorical',
        batch_size=batch_size, preprocess=preprocess_input, shuffle=False, image_normalize=image_normalize, 
        imageset_normalize=imageset_normalize, imageset_mean=imageset_mean, imageset_std=imageset_std)
    sys.stdout.flush()
    if load_val_ram:
        print "Loading validation set into RAM.",
        sys.stdout.flush()
        validation_set = load_dat_ram(validation_set, validation_set.nb_sample, image_normalize=image_normalize, 
        imageset_normalize=imageset_normalize, imageset_mean=imageset_mean, imageset_std=imageset_std)
        print "Done."
        sys.stdout.flush()
    ...
    test_generator = test_imgen.flow_from_directory(
        ...
        preprocess=preprocess_input, shuffle=False, image_normalize=image_normalize, 
        imageset_normalize=imageset_normalize, imageset_mean=imageset_mean, imageset_std=imageset_std)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--imageset_mean", dest="imageset_mean", type=float, default=116.77)
    parser.add_argument("--imageset_std", dest="imageset_std", type=float, default=19.23)
